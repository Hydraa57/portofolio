    ...
    <section id="hero" className="relative flex min-h-screen flex-col justify-end px-5 pb-28 pt-24 sm:px-8 sm:pt-28">
      <div className="mx-auto w-full max-w-7xl">
        ...
        <div className="mt-10 sm:mt-14">
          ...
          <h1 className="reveal font-serif mt-3 leading-[0.88] tracking-[-0.025em] reveal-delay-2"
              style={{ fontSize: 'clamp(2.6rem, 11.5vw, 9.8rem)', fontWeight: 300 }}>
            <span className="block">Muhamad</span>
            <span className="block" style={{ fontStyle: 'italic' }}>Hafidz</span>
            <span className="block">Hidayatulloh<span style={{ color: 'var(--terracotta)' }}>.</span></span>
          </h1>
        </div>
