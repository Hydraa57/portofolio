 ...
 */
export default function Laurels({ topText = 'OFFICIAL', mainText = 'SELECTION', year = '2025' }) {
  return (
    <div
    ...
    >
      {/* left laurel */}
      <svg width="22" height="36" viewBox="0 0 22 36" fill="none" className="text-current">
        <path
      ...
      <div className="px-1 text-center font-mono leading-none">
        <div className="text-[7px] uppercase tracking-[0.25em] opacity-70">{topText}</div>
        <div className="font-serif text-[11px] font-medium italic">{mainText}</div>
        <div className="text-[7px] uppercase tracking-[0.25em] opacity-70">{year}</div>
      </div>
